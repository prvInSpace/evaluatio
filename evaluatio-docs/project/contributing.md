...
Please reach out to me personally on my email [prv21fgt@bangor.ac.uk](emailto:prv21fgt@bangor.ac.uk) or please submit an issue to our [main repository](https://codeberg.org/prvinspace/evaluatio). I want to encourage as many as possible to contribute, so know that I'm here to help should you need it.

## Submitting issues or feature requests
If you discover a problem with the library feel free to submit an issue to our [main repository](https://codeberg.org/prvinspace/evaluatio). Please ensure that the issue is as detailed as possible to make resolving the issue as smooth as possible.
