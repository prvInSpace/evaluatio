...
def cohens_d_independent(x1: Iterable[float], x2: Iterable[float]) -> float:
    ...
    Notes
    -----
    At least two samples is required in each array for the variances to make sense.
    Should work with any type that is castable to a f64, hence ints, floats, and bools.
    """
